...
@NgModule({
  declarations: [CurrenciesComponent, CountriesComponent, UomsComponent, RegionsComponent, FactorycodesComponent, PaymenttermsComponent, DepartmentsComponent, VendorgroupsComponent, VendorsComponent, CompanysComponent, CompanyFormComponent, RoleSettingsComponent, UsersComponent],
  imports: [
    CommonModule,
    AlertModule,
    SharedModule,
