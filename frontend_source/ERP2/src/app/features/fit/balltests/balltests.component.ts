...
constructor(private fb: FormBuilder, private store: Store<any>) {
  ...
  private buildForm() {
    ...
    this.fg = this.fb.group({
      ...
      project:[this.balltest? this.relationId(this.balltest.project) : this.projectId, Validators.required],
      version:[this.balltest?this.balltest.version:'',Validators.required],
      model_name:[this.balltest?this.relationId(this.balltest.model_name):null,Validators.required],
      ...
      test:[this.balltest?this.relationId(this.balltest.test):null,Validators.required],
