...
export class MaterialtestsComponent implements OnInit {
  ...
  private buildForm() {
    ...
    this.fg = this.fb.group({
      ...
      material_name: [this.materialtest ? this.relationId(this.materialtest.material_name) : null],
      project: [this.materialtest ? this.relationId(this.materialtest.project) : this.projectId, Validators.required],
      ...
      test: [this.materialtest ? this.relationId(this.materialtest.test) : null, Validators.required],
