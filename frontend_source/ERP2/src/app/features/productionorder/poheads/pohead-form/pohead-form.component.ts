...
export class PoheadFormComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    // })
    if(this.pohead){
      this.customer = this.store.select(selectByClientID, this.relationId(this.pohead.client))
  ...
  private buildForm() {
    ...
    this.fg = this.fb.group({
      ...
      client:[this.pohead?this.relationId(this.pohead.client):null,Validators.required],
      customer:[this.pohead?this.relationId(this.pohead.customer):null,Validators.required],
      factory:[this.pohead?this.relationId(this.pohead.factory):null,Validators.required],
      identifier:[this.pohead?this.relationId(this.pohead.identifier):null,Validators.required],
      delay_reason:[this.pohead?this.relationId(this.pohead.delay_reason):null,Validators.required],
