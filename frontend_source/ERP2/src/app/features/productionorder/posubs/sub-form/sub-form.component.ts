...
export class SubFormComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    if (this.posub) {
      ...
      this.articles = this.store.select(selectByModelsID, this.relationId(this.posub.model))
    }
  ...
  private buildForm() {
    this.fg = this.fb.group({
      ...
      production_order: [this.pohead ? this.pohead.id : this.posub ? this.relationId(this.posub.production_order) : null, Validators.required],
      model: [this.posub ? this.relationId(this.posub.model) : null, Validators.required],
      article: [this.posub ? this.relationId(this.posub.article) : null, Validators.required],
