...
const loadAccounts = Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_0__["createAction"])('[Account/API] Load Accounts');
const loadAccountsSuccess = Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_0__["createAction"])('[Account/API] Load Accounts Success', Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_0__["props"])());
const addAccount = Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_0__["createAction"])('[Account/API] Add Account', Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_0__["props"])());
const addAccountSuccess = Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_0__["createAction"])('[Account/API] Add Account Success', Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_0__["props"])());
const deleteAccount = Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_0__["createAction"])('[Account/API] Delete Account', Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_0__["props"])());
const deleteAccountSuccess = Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_0__["createAction"])('[Account/API] Delete Account Success', Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_0__["props"])());
...
let AccountEffects = class AccountEffects {
    constructor(actions$, store, service) {
        ...
        this.loadAccounts$ = Object(_ngrx_effects__WEBPACK_IMPORTED_MODULE_2__["createEffect"])(() => this.actions$.pipe(Object(_ngrx_effects__WEBPACK_IMPORTED_MODULE_2__["ofType"])(_account_actions__WEBPACK_IMPORTED_MODULE_5__["loadAccounts"]), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_6__["withLatestFrom"])(this.store.select(_account_selectors__WEBPACK_IMPORTED_MODULE_7__["allAccountLoaded"])), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_6__["filter"])(([_, allLoaded]) => !allLoaded), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_6__["mergeMap"])(_ => this.service.findAll().pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_6__["map"])(data => Object(_account_actions__WEBPACK_IMPORTED_MODULE_5__["loadAccountsSuccess"])({ data }))))));
        this.addAccount$ = Object(_ngrx_effects__WEBPACK_IMPORTED_MODULE_2__["createEffect"])(() => this.actions$.pipe(Object(_ngrx_effects__WEBPACK_IMPORTED_MODULE_2__["ofType"])(_account_actions__WEBPACK_IMPORTED_MODULE_5__["addAccount"]), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_6__["mergeMap"])(action => this.service.save(action.data).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_6__["map"])(data => Object(_account_actions__WEBPACK_IMPORTED_MODULE_5__["addAccountSuccess"])({ data }))))));
        this.deleteAccount$ = Object(_ngrx_effects__WEBPACK_IMPORTED_MODULE_2__["createEffect"])(() => this.actions$.pipe(Object(_ngrx_effects__WEBPACK_IMPORTED_MODULE_2__["ofType"])(_account_actions__WEBPACK_IMPORTED_MODULE_5__["deleteAccount"]), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_6__["mergeMap"])(({ id }) => this.service.delete(id).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_6__["map"])(_ => Object(_account_actions__WEBPACK_IMPORTED_MODULE_5__["deleteAccountSuccess"])({ id }))))));
    }
};
...
const accountFeatureKey = 'accounts';
const adapter = Object(_ngrx_entity__WEBPACK_IMPORTED_MODULE_1__["createEntityAdapter"])();
const initialState = adapter.getInitialState({
    allLoaded: false,
});
const accountReducer = Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_0__["createReducer"])(initialState, Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_0__["on"])(_account_actions__WEBPACK_IMPORTED_MODULE_2__["addAccountSuccess"], (state, action) => adapter.upsertOne(action.data, state)), Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_0__["on"])(_account_actions__WEBPACK_IMPORTED_MODULE_2__["deleteAccountSuccess"], (state, action) => adapter.removeOne(action.id, state)), Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_0__["on"])(_account_actions__WEBPACK_IMPORTED_MODULE_2__["loadAccountsSuccess"], (state, action) => adapter.addAll(action.data, state)));
...
const featureState = Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_0__["createFeatureSelector"])(_account_reducer__WEBPACK_IMPORTED_MODULE_1__["accountFeatureKey"]);
const selectAllAccounts = Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_0__["createSelector"])(featureState, _account_reducer__WEBPACK_IMPORTED_MODULE_1__["selectAll"]);
const allAccountLoaded = Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_0__["createSelector"])(featureState, state => state.allLoaded);
const selectAllExceptCashInHand = Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_0__["createSelector"])(selectAllAccounts, heads => heads.filter(h => parseInt(h.id) !== 3));
...
//# sourceMappingURL=features-about-about-module-es2015.js.map