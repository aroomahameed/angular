...
var CategoriesComponent = /** @class */ (function () {
    function CategoriesComponent(store) {
        this.store = store;
        this.form = [];
        this.columns = [
...
var CategorytypesComponent = /** @class */ (function () {
    function CategorytypesComponent() {
        this.form = [
            {
                row: [
    ...
    CategorytypesComponent.prototype.ngOnInit = function () {
    };
...
var MaterialFormComponent = /** @class */ (function () {
    function MaterialFormComponent(fb, store) {
        this.fb = fb;
        this.store = store;
    ...
    MaterialFormComponent.prototype.handlefileinput = function (file) {
        var _this = this;
...
var MaterialsComponent = /** @class */ (function () {
    function MaterialsComponent(modalService, store, dialogService) {
    ...
    MaterialsComponent.prototype.onCreate = function () {
        ...
        this.modalService.show(_material_form_material_form_component__WEBPACK_IMPORTED_MODULE_4__["MaterialFormComponent"], { initialState: initialState, class: 'modal-lg' });
    };
    MaterialsComponent.prototype.onEdit = function (materials) {
        var initialState = {
            materials: materials,
            title: 'Update',
    ...
    MaterialsComponent.prototype.ondelete = function (id) {
    ...
    MaterialsComponent.ctorParameters = function () { return [
...
var MaterialseasonsComponent = /** @class */ (function () {
    function MaterialseasonsComponent(modalService, store) {
        this.modalService = modalService;
        this.store = store;
        this.columns = [
    ...
    MaterialseasonsComponent.prototype.ngOnInit = function () {
    ...
    MaterialseasonsComponent.prototype.onCreate = function () {
        var initialState = {
            title: 'Add',
            material: this.matId
        };
        this.modalService.show(_season_from_season_from_component__WEBPACK_IMPORTED_MODULE_4__["SeasonFromComponent"], { initialState: initialState, class: 'modal-xm' });
    };
    MaterialseasonsComponent.prototype.onEdit = function (materialseason) {
        var initialState = {
    ...
    MaterialseasonsComponent.prototype.ondelete = function (id) {
    ...
    MaterialseasonsComponent.ctorParameters = function () { return [
        { type: ngx_bootstrap_modal__WEBPACK_IMPORTED_MODULE_3__["BsModalService"] },
        { type: _ngrx_store__WEBPACK_IMPORTED_MODULE_5__["Store"] }
    ]; };
    tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    ...
    return MaterialseasonsComponent;
}());
...
var SeasonFromComponent = /** @class */ (function () {
    function SeasonFromComponent(fb, store) {
        this.fb = fb;
        this.store = store;
        this.submitted = false;
        this.title = 'Add';
    }
    SeasonFromComponent.prototype.ngOnInit = function () {
        this.buildForm();
    ...
    Object.defineProperty(SeasonFromComponent.prototype, "f", {
        // convenience getter for easy access to form fields
        get: function () { return this.fg.controls; },
        enumerable: true,
        configurable: true
    });
    SeasonFromComponent.prototype.buildForm = function () {
        this.fg = this.fb.group({
    ...
    SeasonFromComponent.prototype.onSubmit = function (event) {
        var _this = this;
        Object.keys(this.fg.controls).forEach(function (field) {
            var control = _this.fg.get(field);
            control.markAsTouched({ onlySelf: true });
    ...
    SeasonFromComponent.ctorParameters = function () { return [
...
var MaterialvendorFormComponent = /** @class */ (function () {
    function MaterialvendorFormComponent(fb, store) {
        this.fb = fb;
        this.store = store;
        this.submitted = false;
        this.title = 'Add';
    }
    MaterialvendorFormComponent.prototype.ngOnInit = function () {
        this.buildForm();
    ...
    Object.defineProperty(MaterialvendorFormComponent.prototype, "f", {
        // convenience getter for easy access to form fields
        get: function () { return this.fg.controls; },
        enumerable: true,
        configurable: true
    });
    MaterialvendorFormComponent.prototype.buildForm = function () {
        this.fg = this.fb.group({
    ...
    MaterialvendorFormComponent.prototype.onSubmit = function (event) {
        var _this = this;
        Object.keys(this.fg.controls).forEach(function (field) {
            var control = _this.fg.get(field);
            control.markAsTouched({ onlySelf: true });
    ...
    MaterialvendorFormComponent.ctorParameters = function () { return [
        { type: _angular_forms__WEBPACK_IMPORTED_MODULE_6__["FormBuilder"] },
        { type: _ngrx_store__WEBPACK_IMPORTED_MODULE_7__["Store"] }
    ]; };
    ...
    return MaterialvendorFormComponent;
}());
...
var MaterialvendorsComponent = /** @class */ (function () {
    function MaterialvendorsComponent(modalService, store) {
        this.modalService = modalService;
        this.store = store;
        this.columns = [
    ...
    MaterialvendorsComponent.prototype.ngOnInit = function () {
    ...
    MaterialvendorsComponent.prototype.onCreate = function () {
        var initialState = {
            title: 'Add',
            material: this.matId
        };
        this.modalService.show(_materialvendor_form_materialvendor_form_component__WEBPACK_IMPORTED_MODULE_4__["MaterialvendorFormComponent"], { initialState: initialState, class: 'modal-lg' });
    };
    MaterialvendorsComponent.prototype.onEdit = function (materialvendor) {
        var initialState = {
    ...
    return MaterialvendorsComponent;
}());
...
var SubcategoriesComponent = /** @class */ (function () {
    function SubcategoriesComponent(store) {
        this.store = store;
        this.form = [];
        this.columns = [
...
var CategoryEffects = /** @class */ (function () {
    function CategoryEffects(actions$, store, service) {
        var _this = this;
        this.actions$ = actions$;
        this.store = store;
        this.service = service;
        this.loadCategories$ = Object(_ngrx_effects__WEBPACK_IMPORTED_MODULE_2__["createEffect"])(function () { return _this.actions$.pipe(Object(_ngrx_effects__WEBPACK_IMPORTED_MODULE_2__["ofType"])(_category_actions__WEBPACK_IMPORTED_MODULE_3__["loadCategories"]), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["withLatestFrom"])(_this.store.select(_category_selectors__WEBPACK_IMPORTED_MODULE_4__["allCategoryLoaded"])), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["filter"])(function (_a) {
            var _b = tslib__WEBPACK_IMPORTED_MODULE_0__["__read"](_a, 2), _ = _b[0], allLoaded = _b[1];
            return !allLoaded;
        }), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["mergeMap"])(function (_) { return _this.service.findAll().pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["map"])(function (data) { return Object(_category_actions__WEBPACK_IMPORTED_MODULE_3__["loadCategoriesSuccess"])({ data: data }); })); })); });
    }
    CategoryEffects.ctorParameters = function () { return [
...
var categoryFeatureKey = 'categories';
var adapter = Object(_ngrx_entity__WEBPACK_IMPORTED_MODULE_1__["createEntityAdapter"])();
var initialState = adapter.getInitialState({
    allLoaded: false,
});
var categoryReducer = Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_0__["createReducer"])(initialState, Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_0__["on"])(_category_category_actions__WEBPACK_IMPORTED_MODULE_2__["loadCategoriesSuccess"], function (state, action) { return adapter.addAll(action.data, state); }));
...
var featureState = Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_0__["createFeatureSelector"])(_category_reducer__WEBPACK_IMPORTED_MODULE_1__["categoryFeatureKey"]);
var selectAllCategories = Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_0__["createSelector"])(featureState, _category_reducer__WEBPACK_IMPORTED_MODULE_1__["selectAll"]);
var allCategoryLoaded = Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_0__["createSelector"])(featureState, function (state) { return state.allLoaded; });
...
var addCategorySuccess = Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_0__["createAction"])('[Category/API] Add Category Success', Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_0__["props"])());
...
var selectCurrentCategorySuccess = Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_0__["createAction"])('[Category/API] Select Current Category', Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_0__["props"])());
...
var CategoryEffects = /** @class */ (function () {
    function CategoryEffects(actions$, store, service) {
        ...
        this.store = store;
        this.service = service;
        this.loadCategories$ = Object(_ngrx_effects__WEBPACK_IMPORTED_MODULE_2__["createEffect"])(function () { return _this.actions$.pipe(Object(_ngrx_effects__WEBPACK_IMPORTED_MODULE_2__["ofType"])(_category_actions__WEBPACK_IMPORTED_MODULE_5__["loadCategories"]), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_6__["withLatestFrom"])(_this.store.select(_category_selectors__WEBPACK_IMPORTED_MODULE_7__["allCategoryLoaded"])), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_6__["filter"])(function (_a) {
            var _b = tslib__WEBPACK_IMPORTED_MODULE_0__["__read"](_a, 2), _ = _b[0], allLoaded = _b[1];
            return !allLoaded;
        }), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_6__["mergeMap"])(function (_) { return _this.service.findAll().pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_6__["map"])(function (data) { return Object(_category_actions__WEBPACK_IMPORTED_MODULE_5__["loadCategoriesSuccess"])({ data: data }); })); })); });
        this.addCategory$ = Object(_ngrx_effects__WEBPACK_IMPORTED_MODULE_2__["createEffect"])(function () { return _this.actions$.pipe(Object(_ngrx_effects__WEBPACK_IMPORTED_MODULE_2__["ofType"])(_category_actions__WEBPACK_IMPORTED_MODULE_5__["addCategory"]), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_6__["mergeMap"])(function (action) { return _this.service.save(action.data).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_6__["map"])(function (data) { return Object(_category_actions__WEBPACK_IMPORTED_MODULE_5__["addCategorySuccess"])({ data: data }); })); })); });
        this.deleteCategory$ = Object(_ngrx_effects__WEBPACK_IMPORTED_MODULE_2__["createEffect"])(function () { return _this.actions$.pipe(Object(_ngrx_effects__WEBPACK_IMPORTED_MODULE_2__["ofType"])(_category_actions__WEBPACK_IMPORTED_MODULE_5__["deleteCategory"]), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_6__["mergeMap"])(function (_a) {
            var data = _a.data;
            return _this.service.delete(data).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_6__["map"])(function (_) { return Object(_category_actions__WEBPACK_IMPORTED_MODULE_5__["deleteCategorySuccess"])({ id: data.id }); }));
        })); });
    }
    CategoryEffects.ctorParameters = function () { return [
        { type: _ngrx_effects__WEBPACK_IMPORTED_MODULE_2__["Actions"] },
...
/* harmony import */ var _category_actions__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./category.actions */ "./src/app/features/store/merchandise/category/category.actions.ts");
...
var categoryReducer = Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_1__["createReducer"])(initialState, Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_1__["on"])(_category_actions__WEBPACK_IMPORTED_MODULE_3__["addCategorySuccess"], function (state, action) { return adapter.upsertOne(action.data, tslib__WEBPACK_IMPORTED_MODULE_0__["__assign"]({}, state, { currentCategory: action.data })); }), Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_1__["on"])(_category_actions__WEBPACK_IMPORTED_MODULE_3__["deleteCategorySuccess"], function (state, action) { return adapter.removeOne(action.id, state); }), Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_1__["on"])(_category_actions__WEBPACK_IMPORTED_MODULE_3__["loadCategoriesSuccess"], function (state, action) { return adapter.addAll(action.data, state); }), Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_1__["on"])(_category_actions__WEBPACK_IMPORTED_MODULE_3__["selectCurrentCategorySuccess"], function (state, action) { return (tslib__WEBPACK_IMPORTED_MODULE_0__["__assign"]({}, state, { currentCategory: action.data })); }));
function reducer(state, action) {
    return categoryReducer(state, action);
}
var selectIds = (_a = adapter.getSelectors(), _a.selectIds), selectEntities = _a.selectEntities, selectAll = _a.selectAll, selectTotal = _a.selectTotal;
...
var featureState = Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_0__["createFeatureSelector"])(_category_reducer__WEBPACK_IMPORTED_MODULE_1__["categoryFeatureKey"]);
var selectAllCategories = Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_0__["createSelector"])(featureState, _category_reducer__WEBPACK_IMPORTED_MODULE_1__["selectAll"]);
var allCategoryLoaded = Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_0__["createSelector"])(featureState, function (state) { return state.allCategoriesLoaded; });
var selectCurrentCategory = Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_0__["createSelector"])(featureState, function (state) { return state.currentCategory; });
...
var CategoryService = /** @class */ (function () {
    ...
    CategoryService.prototype.save = function (item) {
        if (!item.id) {
    ...
    CategoryService.prototype.update = function (item) {
        return this.http.put("" + this.url + item.id + "/", item);
    };
    CategoryService.prototype.delete = function (item) {
...
var loadCategorytypes = Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_0__["createAction"])('[Categorytype/API] Load Categorytypes');
var loadCategorytypesSuccess = Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_0__["createAction"])('[Categorytype/API] Load Categorytypes Success', Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_0__["props"])());
var addCategorytype = Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_0__["createAction"])('[Categorytype/API] Add Categorytype', Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_0__["props"])());
var addCategorytypeSuccess = Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_0__["createAction"])('[Categorytype/API] Add Categorytype Success', Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_0__["props"])());
var deleteCategorytype = Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_0__["createAction"])('[Categorytype/API] Delete Categorytype', Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_0__["props"])());
var deleteCategorytypeSuccess = Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_0__["createAction"])('[Categorytype/API] Delete Categorytype Success', Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_0__["props"])());
var selectCurrentCategorytypeSuccess = Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_0__["createAction"])('[Categorytype/API] Select Current Categorytype', Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_0__["props"])());
...
var CategorytypeEffects = /** @class */ (function () {
    function CategorytypeEffects(actions$, store, service) {
        var _this = this;
        this.actions$ = actions$;
        this.store = store;
        this.service = service;
        this.loadCategorytypes$ = Object(_ngrx_effects__WEBPACK_IMPORTED_MODULE_2__["createEffect"])(function () { return _this.actions$.pipe(Object(_ngrx_effects__WEBPACK_IMPORTED_MODULE_2__["ofType"])(_categorytype_actions__WEBPACK_IMPORTED_MODULE_5__["loadCategorytypes"]), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_6__["withLatestFrom"])(_this.store.select(_categorytype_selectors__WEBPACK_IMPORTED_MODULE_7__["allCategorytypeLoaded"])), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_6__["filter"])(function (_a) {
            var _b = tslib__WEBPACK_IMPORTED_MODULE_0__["__read"](_a, 2), _ = _b[0], allLoaded = _b[1];
            return !allLoaded;
        }), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_6__["mergeMap"])(function (_) { return _this.service.findAll().pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_6__["map"])(function (data) { return Object(_categorytype_actions__WEBPACK_IMPORTED_MODULE_5__["loadCategorytypesSuccess"])({ data: data }); })); })); });
        this.addCategorytype$ = Object(_ngrx_effects__WEBPACK_IMPORTED_MODULE_2__["createEffect"])(function () { return _this.actions$.pipe(Object(_ngrx_effects__WEBPACK_IMPORTED_MODULE_2__["ofType"])(_categorytype_actions__WEBPACK_IMPORTED_MODULE_5__["addCategorytype"]), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_6__["mergeMap"])(function (action) { return _this.service.save(action.data).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_6__["map"])(function (data) { return Object(_categorytype_actions__WEBPACK_IMPORTED_MODULE_5__["addCategorytypeSuccess"])({ data: data }); })); })); });
        this.deleteCategorytype$ = Object(_ngrx_effects__WEBPACK_IMPORTED_MODULE_2__["createEffect"])(function () { return _this.actions$.pipe(Object(_ngrx_effects__WEBPACK_IMPORTED_MODULE_2__["ofType"])(_categorytype_actions__WEBPACK_IMPORTED_MODULE_5__["deleteCategorytype"]), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_6__["mergeMap"])(function (_a) {
            var data = _a.data;
            return _this.service.delete(data).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_6__["map"])(function (_) { return Object(_categorytype_actions__WEBPACK_IMPORTED_MODULE_5__["deleteCategorytypeSuccess"])({ id: data.id }); }));
        })); });
    }
    CategorytypeEffects.ctorParameters = function () { return [
        { type: _ngrx_effects__WEBPACK_IMPORTED_MODULE_2__["Actions"] },
        { type: _ngrx_store__WEBPACK_IMPORTED_MODULE_3__["Store"] },
...
/* harmony import */ var _ngrx_store__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @ngrx/store */ "./node_modules/@ngrx/store/fesm5/store.js");
/* harmony import */ var _ngrx_entity__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @ngrx/entity */ "./node_modules/@ngrx/entity/fesm5/entity.js");
/* harmony import */ var _categorytype_actions__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./categorytype.actions */ "./src/app/features/store/merchandise/categorytype/categorytype.actions.ts");

var _a;



var categorytypeFeatureKey = 'categorytypes';
var adapter = Object(_ngrx_entity__WEBPACK_IMPORTED_MODULE_2__["createEntityAdapter"])();
var initialState = adapter.getInitialState({
    allCategorytypesLoaded: false,
    currentCategorytype: null
});
var categorytypeReducer = Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_1__["createReducer"])(initialState, Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_1__["on"])(_categorytype_actions__WEBPACK_IMPORTED_MODULE_3__["addCategorytypeSuccess"], function (state, action) { return adapter.upsertOne(action.data, tslib__WEBPACK_IMPORTED_MODULE_0__["__assign"]({}, state, { currentCategorytype: action.data })); }), Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_1__["on"])(_categorytype_actions__WEBPACK_IMPORTED_MODULE_3__["deleteCategorytypeSuccess"], function (state, action) { return adapter.removeOne(action.id, state); }), Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_1__["on"])(_categorytype_actions__WEBPACK_IMPORTED_MODULE_3__["loadCategorytypesSuccess"], function (state, action) { return adapter.addAll(action.data, state); }), Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_1__["on"])(_categorytype_actions__WEBPACK_IMPORTED_MODULE_3__["selectCurrentCategorytypeSuccess"], function (state, action) { return (tslib__WEBPACK_IMPORTED_MODULE_0__["__assign"]({}, state, { currentCategorytype: action.data })); }));
function reducer(state, action) {
...
var featureState = Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_0__["createFeatureSelector"])(_categorytype_reducer__WEBPACK_IMPORTED_MODULE_1__["categorytypeFeatureKey"]);
var selectAllCategorytypes = Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_0__["createSelector"])(featureState, _categorytype_reducer__WEBPACK_IMPORTED_MODULE_1__["selectAll"]);
var allCategorytypeLoaded = Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_0__["createSelector"])(featureState, function (state) { return state.allCategorytypesLoaded; });
var selectCurrentCategorytype = Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_0__["createSelector"])(featureState, function (state) { return state.currentCategorytype; });
...
var CategorytypeService = /** @class */ (function () {
    function CategorytypeService(http) {
        this.http = http;
        this.url = _app_config__WEBPACK_IMPORTED_MODULE_2__["APP_CONFIG"].BASE_URL + "/category-types/";
    }
    CategorytypeService.prototype.findAll = function () {
        return this.http.get(this.url);
    };
    CategorytypeService.prototype.save = function (item) {
        if (!item.id) {
            return this.http.post(this.url, item);
        }
        else {
    ...
    CategorytypeService.prototype.update = function (item) {
        return this.http.put("" + this.url + item.id + "/", item);
    };
    CategorytypeService.prototype.delete = function (item) {
        return this.http.delete("" + this.url + item.id + "/");
    };
    CategorytypeService.ctorParameters = function () { return [
        { type: _angular_common_http__WEBPACK_IMPORTED_MODULE_3__["HttpClient"] }
    ]; };
...
var loadMaterialseasons = Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_0__["createAction"])('[Materialseason/API] Load Materialseasons');
var loadMaterialseasonsSuccess = Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_0__["createAction"])('[Materialseason/API] Load Materialseasons Success', Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_0__["props"])());
var addMaterialseason = Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_0__["createAction"])('[Materialseason/API] Add Materialseason', Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_0__["props"])());
var addMaterialseasonSuccess = Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_0__["createAction"])('[Materialseason/API] Add Materialseason Success', Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_0__["props"])());
var deleteMaterialseason = Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_0__["createAction"])('[Materialseason/API] Delete Materialseason', Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_0__["props"])());
var deleteMaterialseasonSuccess = Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_0__["createAction"])('[Materialseason/API] Delete Materialseason Success', Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_0__["props"])());
var selectCurrentMaterialseasonSuccess = Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_0__["createAction"])('[Materialseason/API] Select Current Materialseason', Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_0__["props"])());
...
var MaterialseasonEffects = /** @class */ (function () {
    function MaterialseasonEffects(actions$, store, service) {
        var _this = this;
        this.actions$ = actions$;
        this.store = store;
        this.service = service;
        this.loadMaterialseasons$ = Object(_ngrx_effects__WEBPACK_IMPORTED_MODULE_2__["createEffect"])(function () { return _this.actions$.pipe(Object(_ngrx_effects__WEBPACK_IMPORTED_MODULE_2__["ofType"])(_materialseason_actions__WEBPACK_IMPORTED_MODULE_5__["loadMaterialseasons"]), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_6__["withLatestFrom"])(_this.store.select(_materialseason_selectors__WEBPACK_IMPORTED_MODULE_7__["allMaterialseasonLoaded"])), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_6__["filter"])(function (_a) {
            var _b = tslib__WEBPACK_IMPORTED_MODULE_0__["__read"](_a, 2), _ = _b[0], allLoaded = _b[1];
            return !allLoaded;
        }), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_6__["mergeMap"])(function (_) { return _this.service.findAll().pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_6__["map"])(function (data) { return Object(_materialseason_actions__WEBPACK_IMPORTED_MODULE_5__["loadMaterialseasonsSuccess"])({ data: data }); })); })); });
        this.addMaterialseason$ = Object(_ngrx_effects__WEBPACK_IMPORTED_MODULE_2__["createEffect"])(function () { return _this.actions$.pipe(Object(_ngrx_effects__WEBPACK_IMPORTED_MODULE_2__["ofType"])(_materialseason_actions__WEBPACK_IMPORTED_MODULE_5__["addMaterialseason"]), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_6__["mergeMap"])(function (action) { return _this.service.save(action.data).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_6__["map"])(function (data) { return Object(_materialseason_actions__WEBPACK_IMPORTED_MODULE_5__["addMaterialseasonSuccess"])({ data: data }); })); })); });
        this.deleteMaterialseason$ = Object(_ngrx_effects__WEBPACK_IMPORTED_MODULE_2__["createEffect"])(function () { return _this.actions$.pipe(Object(_ngrx_effects__WEBPACK_IMPORTED_MODULE_2__["ofType"])(_materialseason_actions__WEBPACK_IMPORTED_MODULE_5__["deleteMaterialseason"]), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_6__["mergeMap"])(function (_a) {
            var data = _a.data;
            return _this.service.delete(data).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_6__["map"])(function (_) { return Object(_materialseason_actions__WEBPACK_IMPORTED_MODULE_5__["deleteMaterialseasonSuccess"])({ id: data.id }); }));
        })); });
    }
    MaterialseasonEffects.ctorParameters = function () { return [
        { type: _ngrx_effects__WEBPACK_IMPORTED_MODULE_2__["Actions"] },
        { type: _ngrx_store__WEBPACK_IMPORTED_MODULE_3__["Store"] },
...
/* harmony import */ var _ngrx_store__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @ngrx/store */ "./node_modules/@ngrx/store/fesm5/store.js");
/* harmony import */ var _ngrx_entity__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @ngrx/entity */ "./node_modules/@ngrx/entity/fesm5/entity.js");
/* harmony import */ var _materialseason_actions__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./materialseason.actions */ "./src/app/features/store/merchandise/materialseason/materialseason.actions.ts");

var _a;



var materialseasonFeatureKey = 'materialseasons';
var adapter = Object(_ngrx_entity__WEBPACK_IMPORTED_MODULE_2__["createEntityAdapter"])();
var initialState = adapter.getInitialState({
    allMaterialseasonsLoaded: false,
    currentMaterialseason: null
});
var materialseasonReducer = Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_1__["createReducer"])(initialState, Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_1__["on"])(_materialseason_actions__WEBPACK_IMPORTED_MODULE_3__["addMaterialseasonSuccess"], function (state, action) { return adapter.upsertOne(action.data, tslib__WEBPACK_IMPORTED_MODULE_0__["__assign"]({}, state, { currentMaterialseason: action.data })); }), Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_1__["on"])(_materialseason_actions__WEBPACK_IMPORTED_MODULE_3__["deleteMaterialseasonSuccess"], function (state, action) { return adapter.removeOne(action.id, state); }), Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_1__["on"])(_materialseason_actions__WEBPACK_IMPORTED_MODULE_3__["loadMaterialseasonsSuccess"], function (state, action) { return adapter.addAll(action.data, state); }), Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_1__["on"])(_materialseason_actions__WEBPACK_IMPORTED_MODULE_3__["selectCurrentMaterialseasonSuccess"], function (state, action) { return (tslib__WEBPACK_IMPORTED_MODULE_0__["__assign"]({}, state, { currentMaterialseason: action.data })); }));
function reducer(state, action) {
...
var featureState = Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_0__["createFeatureSelector"])(_materialseason_reducer__WEBPACK_IMPORTED_MODULE_1__["materialseasonFeatureKey"]);
var selectAllMaterialseasons = Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_0__["createSelector"])(featureState, _materialseason_reducer__WEBPACK_IMPORTED_MODULE_1__["selectAll"]);
var allMaterialseasonLoaded = Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_0__["createSelector"])(featureState, function (state) { return state.allMaterialseasonsLoaded; });
var selectCurrentMaterialseason = Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_0__["createSelector"])(featureState, function (state) { return state.currentMaterialseason; });
var selectseasonBymaterialID = Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_0__["createSelector"])(selectAllMaterialseasons, function (material, id) {
    var mat = material.filter(function (m) { return m.material.id == id; });
    return mat;
});
...
var MaterialseasonService = /** @class */ (function () {
    function MaterialseasonService(http) {
        this.http = http;
        this.url = _app_config__WEBPACK_IMPORTED_MODULE_2__["APP_CONFIG"].BASE_URL + "/material-seasons/";
    }
    MaterialseasonService.prototype.findAll = function () {
        return this.http.get(this.url);
    };
    MaterialseasonService.prototype.save = function (item) {
        if (!item.id) {
            return this.http.post(this.url, item);
        }
        else {
    ...
    MaterialseasonService.prototype.update = function (item) {
        return this.http.put("" + this.url + item.id + "/", item);
    };
    MaterialseasonService.prototype.delete = function (item) {
        return this.http.delete("" + this.url + item.id + "/");
    };
    MaterialseasonService.ctorParameters = function () { return [
        { type: _angular_common_http__WEBPACK_IMPORTED_MODULE_3__["HttpClient"] }
    ]; };
...
var loadMaterialvendors = Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_0__["createAction"])('[Materialvendor/API] Load Materialvendors');
var loadMaterialvendorsSuccess = Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_0__["createAction"])('[Materialvendor/API] Load Materialvendors Success', Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_0__["props"])());
var addMaterialvendor = Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_0__["createAction"])('[Materialvendor/API] Add Materialvendor', Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_0__["props"])());
var addMaterialvendorSuccess = Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_0__["createAction"])('[Materialvendor/API] Add Materialvendor Success', Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_0__["props"])());
var deleteMaterialvendor = Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_0__["createAction"])('[Materialvendor/API] Delete Materialvendor', Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_0__["props"])());
var deleteMaterialvendorSuccess = Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_0__["createAction"])('[Materialvendor/API] Delete Materialvendor Success', Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_0__["props"])());
var selectCurrentMaterialvendorSuccess = Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_0__["createAction"])('[Materialvendor/API] Select Current Materialvendor', Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_0__["props"])());
...
var MaterialvendorEffects = /** @class */ (function () {
    function MaterialvendorEffects(actions$, store, service) {
        var _this = this;
        this.actions$ = actions$;
        this.store = store;
        this.service = service;
        this.loadMaterialvendors$ = Object(_ngrx_effects__WEBPACK_IMPORTED_MODULE_2__["createEffect"])(function () { return _this.actions$.pipe(Object(_ngrx_effects__WEBPACK_IMPORTED_MODULE_2__["ofType"])(_materialvendor_actions__WEBPACK_IMPORTED_MODULE_5__["loadMaterialvendors"]), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_6__["withLatestFrom"])(_this.store.select(_materialvendor_selectors__WEBPACK_IMPORTED_MODULE_7__["allMaterialvendorLoaded"])), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_6__["filter"])(function (_a) {
            var _b = tslib__WEBPACK_IMPORTED_MODULE_0__["__read"](_a, 2), _ = _b[0], allLoaded = _b[1];
            return !allLoaded;
        }), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_6__["mergeMap"])(function (_) { return _this.service.findAll().pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_6__["map"])(function (data) { return Object(_materialvendor_actions__WEBPACK_IMPORTED_MODULE_5__["loadMaterialvendorsSuccess"])({ data: data }); })); })); });
        this.addMaterialvendor$ = Object(_ngrx_effects__WEBPACK_IMPORTED_MODULE_2__["createEffect"])(function () { return _this.actions$.pipe(Object(_ngrx_effects__WEBPACK_IMPORTED_MODULE_2__["ofType"])(_materialvendor_actions__WEBPACK_IMPORTED_MODULE_5__["addMaterialvendor"]), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_6__["mergeMap"])(function (action) { return _this.service.save(action.data).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_6__["map"])(function (data) { return Object(_materialvendor_actions__WEBPACK_IMPORTED_MODULE_5__["addMaterialvendorSuccess"])({ data: data }); })); })); });
        this.deleteMaterialvendor$ = Object(_ngrx_effects__WEBPACK_IMPORTED_MODULE_2__["createEffect"])(function () { return _this.actions$.pipe(Object(_ngrx_effects__WEBPACK_IMPORTED_MODULE_2__["ofType"])(_materialvendor_actions__WEBPACK_IMPORTED_MODULE_5__["deleteMaterialvendor"]), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_6__["mergeMap"])(function (_a) {
            var data = _a.data;
            return _this.service.delete(data).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_6__["map"])(function (_) { return Object(_materialvendor_actions__WEBPACK_IMPORTED_MODULE_5__["deleteMaterialvendorSuccess"])({ id: data.id }); }));
        })); });
    }
    MaterialvendorEffects.ctorParameters = function () { return [
        { type: _ngrx_effects__WEBPACK_IMPORTED_MODULE_2__["Actions"] },
        { type: _ngrx_store__WEBPACK_IMPORTED_MODULE_3__["Store"] },
...
/* harmony import */ var _ngrx_store__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @ngrx/store */ "./node_modules/@ngrx/store/fesm5/store.js");
/* harmony import */ var _ngrx_entity__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @ngrx/entity */ "./node_modules/@ngrx/entity/fesm5/entity.js");
/* harmony import */ var _materialvendor_actions__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./materialvendor.actions */ "./src/app/features/store/merchandise/materialvendor/materialvendor.actions.ts");

var _a;



var materialvendorFeatureKey = 'materialvendors';
var adapter = Object(_ngrx_entity__WEBPACK_IMPORTED_MODULE_2__["createEntityAdapter"])();
var initialState = adapter.getInitialState({
    allMaterialvendorsLoaded: false,
    currentMaterialvendor: null
});
var materialvendorReducer = Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_1__["createReducer"])(initialState, Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_1__["on"])(_materialvendor_actions__WEBPACK_IMPORTED_MODULE_3__["addMaterialvendorSuccess"], function (state, action) { return adapter.upsertOne(action.data, tslib__WEBPACK_IMPORTED_MODULE_0__["__assign"]({}, state, { currentMaterialvendor: action.data })); }), Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_1__["on"])(_materialvendor_actions__WEBPACK_IMPORTED_MODULE_3__["deleteMaterialvendorSuccess"], function (state, action) { return adapter.removeOne(action.id, state); }), Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_1__["on"])(_materialvendor_actions__WEBPACK_IMPORTED_MODULE_3__["loadMaterialvendorsSuccess"], function (state, action) { return adapter.addAll(action.data, state); }), Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_1__["on"])(_materialvendor_actions__WEBPACK_IMPORTED_MODULE_3__["selectCurrentMaterialvendorSuccess"], function (state, action) { return (tslib__WEBPACK_IMPORTED_MODULE_0__["__assign"]({}, state, { currentMaterialvendor: action.data })); }));
function reducer(state, action) {
...
var featureState = Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_0__["createFeatureSelector"])(_materialvendor_reducer__WEBPACK_IMPORTED_MODULE_1__["materialvendorFeatureKey"]);
var selectAllMaterialvendors = Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_0__["createSelector"])(featureState, _materialvendor_reducer__WEBPACK_IMPORTED_MODULE_1__["selectAll"]);
var allMaterialvendorLoaded = Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_0__["createSelector"])(featureState, function (state) { return state.allMaterialvendorsLoaded; });
var selectCurrentMaterialvendor = Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_0__["createSelector"])(featureState, function (state) { return state.currentMaterialvendor; });
var selectBymaterialID = Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_0__["createSelector"])(selectAllMaterialvendors, function (material, id) {
    var mat = material.filter(function (m) { return m.material.id == id; });
    return mat;
});
...
var MaterialvendorService = /** @class */ (function () {
    function MaterialvendorService(http) {
        this.http = http;
        this.url = _app_config__WEBPACK_IMPORTED_MODULE_2__["APP_CONFIG"].BASE_URL + "/material-vendors/";
    }
    MaterialvendorService.prototype.findAll = function () {
        return this.http.get(this.url);
    };
    MaterialvendorService.prototype.save = function (item) {
        if (!item.id) {
            return this.http.post(this.url, item);
        }
        else {
    ...
    MaterialvendorService.prototype.update = function (item) {
        return this.http.put("" + this.url + item.id + "/", item);
    };
    MaterialvendorService.prototype.delete = function (item) {
        return this.http.delete("" + this.url + item.id + "/");
    };
    MaterialvendorService.ctorParameters = function () { return [
        { type: _angular_common_http__WEBPACK_IMPORTED_MODULE_3__["HttpClient"] }
    ]; };
...
var loadSubcategories = Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_0__["createAction"])('[Subcategory/API] Load Subcategories');
var loadSubcategoriesSuccess = Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_0__["createAction"])('[Subcategory/API] Load Subcategories Success', Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_0__["props"])());
var addSubcategory = Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_0__["createAction"])('[Subcategory/API] Add Subcategory', Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_0__["props"])());
var addSubcategorySuccess = Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_0__["createAction"])('[Subcategory/API] Add Subcategory Success', Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_0__["props"])());
var deleteSubcategory = Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_0__["createAction"])('[Subcategory/API] Delete Subcategory', Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_0__["props"])());
var deleteSubcategorySuccess = Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_0__["createAction"])('[Subcategory/API] Delete Subcategory Success', Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_0__["props"])());
var selectCurrentSubcategorySuccess = Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_0__["createAction"])('[Subcategory/API] Select Current Subcategory', Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_0__["props"])());
...
var SubcategoryEffects = /** @class */ (function () {
    function SubcategoryEffects(actions$, store, service) {
        var _this = this;
        this.actions$ = actions$;
        this.store = store;
        this.service = service;
        this.loadSubcategories$ = Object(_ngrx_effects__WEBPACK_IMPORTED_MODULE_2__["createEffect"])(function () { return _this.actions$.pipe(Object(_ngrx_effects__WEBPACK_IMPORTED_MODULE_2__["ofType"])(_subcategory_actions__WEBPACK_IMPORTED_MODULE_5__["loadSubcategories"]), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_6__["withLatestFrom"])(_this.store.select(_subcategory_selectors__WEBPACK_IMPORTED_MODULE_7__["allSubcategoryLoaded"])), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_6__["filter"])(function (_a) {
            var _b = tslib__WEBPACK_IMPORTED_MODULE_0__["__read"](_a, 2), _ = _b[0], allLoaded = _b[1];
            return !allLoaded;
        }), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_6__["mergeMap"])(function (_) { return _this.service.findAll().pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_6__["map"])(function (data) { return Object(_subcategory_actions__WEBPACK_IMPORTED_MODULE_5__["loadSubcategoriesSuccess"])({ data: data }); })); })); });
        this.addSubcategory$ = Object(_ngrx_effects__WEBPACK_IMPORTED_MODULE_2__["createEffect"])(function () { return _this.actions$.pipe(Object(_ngrx_effects__WEBPACK_IMPORTED_MODULE_2__["ofType"])(_subcategory_actions__WEBPACK_IMPORTED_MODULE_5__["addSubcategory"]), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_6__["mergeMap"])(function (action) { return _this.service.save(action.data).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_6__["map"])(function (data) { return Object(_subcategory_actions__WEBPACK_IMPORTED_MODULE_5__["addSubcategorySuccess"])({ data: data }); })); })); });
        this.deleteSubcategory$ = Object(_ngrx_effects__WEBPACK_IMPORTED_MODULE_2__["createEffect"])(function () { return _this.actions$.pipe(Object(_ngrx_effects__WEBPACK_IMPORTED_MODULE_2__["ofType"])(_subcategory_actions__WEBPACK_IMPORTED_MODULE_5__["deleteSubcategory"]), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_6__["mergeMap"])(function (_a) {
            var data = _a.data;
            return _this.service.delete(data).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_6__["map"])(function (_) { return Object(_subcategory_actions__WEBPACK_IMPORTED_MODULE_5__["deleteSubcategorySuccess"])({ id: data.id }); }));
        })); });
    }
    SubcategoryEffects.ctorParameters = function () { return [
        { type: _ngrx_effects__WEBPACK_IMPORTED_MODULE_2__["Actions"] },
        { type: _ngrx_store__WEBPACK_IMPORTED_MODULE_3__["Store"] },
...
/* harmony import */ var _ngrx_store__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @ngrx/store */ "./node_modules/@ngrx/store/fesm5/store.js");
/* harmony import */ var _ngrx_entity__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @ngrx/entity */ "./node_modules/@ngrx/entity/fesm5/entity.js");
/* harmony import */ var _subcategory_actions__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./subcategory.actions */ "./src/app/features/store/merchandise/subcategory/subcategory.actions.ts");

var _a;



var subcategoryFeatureKey = 'subcategories';
var adapter = Object(_ngrx_entity__WEBPACK_IMPORTED_MODULE_2__["createEntityAdapter"])();
var initialState = adapter.getInitialState({
    allSubcategoriesLoaded: false,
    currentSubcategory: null
});
var subcategoryReducer = Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_1__["createReducer"])(initialState, Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_1__["on"])(_subcategory_actions__WEBPACK_IMPORTED_MODULE_3__["addSubcategorySuccess"], function (state, action) { return adapter.upsertOne(action.data, tslib__WEBPACK_IMPORTED_MODULE_0__["__assign"]({}, state, { currentSubcategory: action.data })); }), Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_1__["on"])(_subcategory_actions__WEBPACK_IMPORTED_MODULE_3__["deleteSubcategorySuccess"], function (state, action) { return adapter.removeOne(action.id, state); }), Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_1__["on"])(_subcategory_actions__WEBPACK_IMPORTED_MODULE_3__["loadSubcategoriesSuccess"], function (state, action) { return adapter.addAll(action.data, state); }), Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_1__["on"])(_subcategory_actions__WEBPACK_IMPORTED_MODULE_3__["selectCurrentSubcategorySuccess"], function (state, action) { return (tslib__WEBPACK_IMPORTED_MODULE_0__["__assign"]({}, state, { currentSubcategory: action.data })); }));
function reducer(state, action) {
...
var featureState = Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_0__["createFeatureSelector"])(_subcategory_reducer__WEBPACK_IMPORTED_MODULE_1__["subcategoryFeatureKey"]);
var selectAllSubcategories = Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_0__["createSelector"])(featureState, _subcategory_reducer__WEBPACK_IMPORTED_MODULE_1__["selectAll"]);
var allSubcategoryLoaded = Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_0__["createSelector"])(featureState, function (state) { return state.allSubcategoriesLoaded; });
var selectCurrentSubcategory = Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_0__["createSelector"])(featureState, function (state) { return state.currentSubcategory; });
...
var SubcategoryService = /** @class */ (function () {
    ...
    SubcategoryService.prototype.save = function (item) {
        if (!item.id) {
            return this.http.post(this.url, item);
        }
        else {
    ...
    SubcategoryService.prototype.update = function (item) {
        return this.http.put("" + this.url + item.id + "/", item);
    };
    SubcategoryService.prototype.delete = function (item) {
        return this.http.delete("" + this.url + item.id + "/");
    };
...
//# sourceMappingURL=features-merchandise-merchandise-module-es5.js.map