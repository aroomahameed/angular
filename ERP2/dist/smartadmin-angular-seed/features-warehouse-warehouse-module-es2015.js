...
const loadLines = Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_0__["createAction"])('[Line/API] Load Lines');
const loadLinesSuccess = Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_0__["createAction"])('[Line/API] Load Lines Success', Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_0__["props"])());
const addLine = Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_0__["createAction"])('[Line/API] Add Line', Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_0__["props"])());
const addLineSuccess = Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_0__["createAction"])('[Line/API] Add Line Success', Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_0__["props"])());
const deleteLine = Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_0__["createAction"])('[Line/API] Delete Line', Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_0__["props"])());
const deleteLineSuccess = Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_0__["createAction"])('[Line/API] Delete Line Success', Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_0__["props"])());
const selectCurrentLineSuccess = Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_0__["createAction"])('[Line/API] Select Current Line', Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_0__["props"])());
...
let LineEffects = class LineEffects {
    constructor(actions$, store, service) {
        this.actions$ = actions$;
        this.store = store;
        this.service = service;
        this.loadLines$ = Object(_ngrx_effects__WEBPACK_IMPORTED_MODULE_2__["createEffect"])(() => this.actions$.pipe(Object(_ngrx_effects__WEBPACK_IMPORTED_MODULE_2__["ofType"])(_line_actions__WEBPACK_IMPORTED_MODULE_5__["loadLines"]), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_6__["withLatestFrom"])(this.store.select(_line_selectors__WEBPACK_IMPORTED_MODULE_7__["allLineLoaded"])), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_6__["filter"])(([_, allLoaded]) => !allLoaded), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_6__["mergeMap"])(_ => this.service.findAll().pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_6__["map"])(data => Object(_line_actions__WEBPACK_IMPORTED_MODULE_5__["loadLinesSuccess"])({ data }))))));
        this.addLine$ = Object(_ngrx_effects__WEBPACK_IMPORTED_MODULE_2__["createEffect"])(() => this.actions$.pipe(Object(_ngrx_effects__WEBPACK_IMPORTED_MODULE_2__["ofType"])(_line_actions__WEBPACK_IMPORTED_MODULE_5__["addLine"]), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_6__["mergeMap"])(action => this.service.save(action.data).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_6__["map"])(data => Object(_line_actions__WEBPACK_IMPORTED_MODULE_5__["addLineSuccess"])({ data }))))));
        this.deleteLine$ = Object(_ngrx_effects__WEBPACK_IMPORTED_MODULE_2__["createEffect"])(() => this.actions$.pipe(Object(_ngrx_effects__WEBPACK_IMPORTED_MODULE_2__["ofType"])(_line_actions__WEBPACK_IMPORTED_MODULE_5__["deleteLine"]), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_6__["mergeMap"])(({ data }) => this.service.delete(data).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_6__["map"])(_ => Object(_line_actions__WEBPACK_IMPORTED_MODULE_5__["deleteLineSuccess"])({ id: data.id }))))));
    }
};
LineEffects.ctorParameters = () => [
...
/* harmony import */ var _line_actions__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./line.actions */ "./src/app/features/store/warehouse/line/line.actions.ts");



const lineFeatureKey = 'lines';
const adapter = Object(_ngrx_entity__WEBPACK_IMPORTED_MODULE_1__["createEntityAdapter"])();
const initialState = adapter.getInitialState({
    allLinesLoaded: false,
    currentLine: null
});
const lineReducer = Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_0__["createReducer"])(initialState, Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_0__["on"])(_line_actions__WEBPACK_IMPORTED_MODULE_2__["addLineSuccess"], (state, action) => adapter.upsertOne(action.data, Object.assign({}, state, { currentLine: action.data }))), Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_0__["on"])(_line_actions__WEBPACK_IMPORTED_MODULE_2__["deleteLineSuccess"], (state, action) => adapter.removeOne(action.id, state)), Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_0__["on"])(_line_actions__WEBPACK_IMPORTED_MODULE_2__["loadLinesSuccess"], (state, action) => adapter.addAll(action.data, state)), Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_0__["on"])(_line_actions__WEBPACK_IMPORTED_MODULE_2__["selectCurrentLineSuccess"], (state, action) => (Object.assign({}, state, { currentLine: action.data }))));
...
const featureState = Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_0__["createFeatureSelector"])(_line_reducer__WEBPACK_IMPORTED_MODULE_1__["lineFeatureKey"]);
const selectAllLines = Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_0__["createSelector"])(featureState, _line_reducer__WEBPACK_IMPORTED_MODULE_1__["selectAll"]);
const allLineLoaded = Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_0__["createSelector"])(featureState, state => state.allLinesLoaded);
const selectCurrentLine = Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_0__["createSelector"])(featureState, state => state.currentLine);
...
const loadRacks = Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_0__["createAction"])('[Rack/API] Load Racks');
const loadRacksSuccess = Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_0__["createAction"])('[Rack/API] Load Racks Success', Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_0__["props"])());
const addRack = Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_0__["createAction"])('[Rack/API] Add Rack', Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_0__["props"])());
const addRackSuccess = Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_0__["createAction"])('[Rack/API] Add Rack Success', Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_0__["props"])());
const deleteRack = Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_0__["createAction"])('[Rack/API] Delete Rack', Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_0__["props"])());
const deleteRackSuccess = Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_0__["createAction"])('[Rack/API] Delete Rack Success', Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_0__["props"])());
const selectCurrentRackSuccess = Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_0__["createAction"])('[Rack/API] Select Current Rack', Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_0__["props"])());
...
let RackEffects = class RackEffects {
    constructor(actions$, store, service) {
        this.actions$ = actions$;
        this.store = store;
        this.service = service;
        this.loadRacks$ = Object(_ngrx_effects__WEBPACK_IMPORTED_MODULE_2__["createEffect"])(() => this.actions$.pipe(Object(_ngrx_effects__WEBPACK_IMPORTED_MODULE_2__["ofType"])(_rack_actions__WEBPACK_IMPORTED_MODULE_5__["loadRacks"]), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_6__["withLatestFrom"])(this.store.select(_rack_selectors__WEBPACK_IMPORTED_MODULE_7__["allRackLoaded"])), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_6__["filter"])(([_, allLoaded]) => !allLoaded), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_6__["mergeMap"])(_ => this.service.findAll().pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_6__["map"])(data => Object(_rack_actions__WEBPACK_IMPORTED_MODULE_5__["loadRacksSuccess"])({ data }))))));
        this.addRack$ = Object(_ngrx_effects__WEBPACK_IMPORTED_MODULE_2__["createEffect"])(() => this.actions$.pipe(Object(_ngrx_effects__WEBPACK_IMPORTED_MODULE_2__["ofType"])(_rack_actions__WEBPACK_IMPORTED_MODULE_5__["addRack"]), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_6__["mergeMap"])(action => this.service.save(action.data).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_6__["map"])(data => Object(_rack_actions__WEBPACK_IMPORTED_MODULE_5__["addRackSuccess"])({ data }))))));
        this.deleteRack$ = Object(_ngrx_effects__WEBPACK_IMPORTED_MODULE_2__["createEffect"])(() => this.actions$.pipe(Object(_ngrx_effects__WEBPACK_IMPORTED_MODULE_2__["ofType"])(_rack_actions__WEBPACK_IMPORTED_MODULE_5__["deleteRack"]), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_6__["mergeMap"])(({ data }) => this.service.delete(data).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_6__["map"])(_ => Object(_rack_actions__WEBPACK_IMPORTED_MODULE_5__["deleteRackSuccess"])({ id: data.id }))))));
    }
};
RackEffects.ctorParameters = () => [
    { type: _ngrx_effects__WEBPACK_IMPORTED_MODULE_2__["Actions"] },
    { type: _ngrx_store__WEBPACK_IMPORTED_MODULE_3__["Store"] },
...
/* harmony import */ var _ngrx_store__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @ngrx/store */ "./node_modules/@ngrx/store/fesm2015/store.js");
/* harmony import */ var _ngrx_entity__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @ngrx/entity */ "./node_modules/@ngrx/entity/fesm2015/entity.js");
/* harmony import */ var _rack_actions__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./rack.actions */ "./src/app/features/store/warehouse/rack/rack.actions.ts");



const rackFeatureKey = 'racks';
const adapter = Object(_ngrx_entity__WEBPACK_IMPORTED_MODULE_1__["createEntityAdapter"])();
const initialState = adapter.getInitialState({
    allRacksLoaded: false,
    currentRack: null
});
const rackReducer = Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_0__["createReducer"])(initialState, Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_0__["on"])(_rack_actions__WEBPACK_IMPORTED_MODULE_2__["addRackSuccess"], (state, action) => adapter.upsertOne(action.data, Object.assign({}, state, { currentRack: action.data }))), Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_0__["on"])(_rack_actions__WEBPACK_IMPORTED_MODULE_2__["deleteRackSuccess"], (state, action) => adapter.removeOne(action.id, state)), Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_0__["on"])(_rack_actions__WEBPACK_IMPORTED_MODULE_2__["loadRacksSuccess"], (state, action) => adapter.addAll(action.data, state)), Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_0__["on"])(_rack_actions__WEBPACK_IMPORTED_MODULE_2__["selectCurrentRackSuccess"], (state, action) => (Object.assign({}, state, { currentRack: action.data }))));
function reducer(state, action) {
...
const featureState = Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_0__["createFeatureSelector"])(_rack_reducer__WEBPACK_IMPORTED_MODULE_1__["rackFeatureKey"]);
const selectAllRacks = Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_0__["createSelector"])(featureState, _rack_reducer__WEBPACK_IMPORTED_MODULE_1__["selectAll"]);
const allRackLoaded = Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_0__["createSelector"])(featureState, state => state.allRacksLoaded);
const selectCurrentRack = Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_0__["createSelector"])(featureState, state => state.currentRack);
...
const loadSections = Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_0__["createAction"])('[Section/API] Load Sections');
const loadSectionsSuccess = Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_0__["createAction"])('[Section/API] Load Sections Success', Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_0__["props"])());
const addSection = Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_0__["createAction"])('[Section/API] Add Section', Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_0__["props"])());
const addSectionSuccess = Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_0__["createAction"])('[Section/API] Add Section Success', Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_0__["props"])());
const deleteSection = Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_0__["createAction"])('[Section/API] Delete Section', Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_0__["props"])());
const deleteSectionSuccess = Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_0__["createAction"])('[Section/API] Delete Section Success', Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_0__["props"])());
const selectCurrentSectionSuccess = Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_0__["createAction"])('[Section/API] Select Current Section', Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_0__["props"])());
...
let SectionEffects = class SectionEffects {
    constructor(actions$, store, service) {
        this.actions$ = actions$;
        this.store = store;
        this.service = service;
        this.loadSections$ = Object(_ngrx_effects__WEBPACK_IMPORTED_MODULE_2__["createEffect"])(() => this.actions$.pipe(Object(_ngrx_effects__WEBPACK_IMPORTED_MODULE_2__["ofType"])(_section_actions__WEBPACK_IMPORTED_MODULE_5__["loadSections"]), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_6__["withLatestFrom"])(this.store.select(_section_selectors__WEBPACK_IMPORTED_MODULE_7__["allSectionLoaded"])), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_6__["filter"])(([_, allLoaded]) => !allLoaded), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_6__["mergeMap"])(_ => this.service.findAll().pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_6__["map"])(data => Object(_section_actions__WEBPACK_IMPORTED_MODULE_5__["loadSectionsSuccess"])({ data }))))));
        this.addSection$ = Object(_ngrx_effects__WEBPACK_IMPORTED_MODULE_2__["createEffect"])(() => this.actions$.pipe(Object(_ngrx_effects__WEBPACK_IMPORTED_MODULE_2__["ofType"])(_section_actions__WEBPACK_IMPORTED_MODULE_5__["addSection"]), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_6__["mergeMap"])(action => this.service.save(action.data).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_6__["map"])(data => Object(_section_actions__WEBPACK_IMPORTED_MODULE_5__["addSectionSuccess"])({ data }))))));
        this.deleteSection$ = Object(_ngrx_effects__WEBPACK_IMPORTED_MODULE_2__["createEffect"])(() => this.actions$.pipe(Object(_ngrx_effects__WEBPACK_IMPORTED_MODULE_2__["ofType"])(_section_actions__WEBPACK_IMPORTED_MODULE_5__["deleteSection"]), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_6__["mergeMap"])(({ data }) => this.service.delete(data).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_6__["map"])(_ => Object(_section_actions__WEBPACK_IMPORTED_MODULE_5__["deleteSectionSuccess"])({ id: data.id }))))));
    }
};
SectionEffects.ctorParameters = () => [
    { type: _ngrx_effects__WEBPACK_IMPORTED_MODULE_2__["Actions"] },
    { type: _ngrx_store__WEBPACK_IMPORTED_MODULE_3__["Store"] },
...
/* harmony import */ var _ngrx_store__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @ngrx/store */ "./node_modules/@ngrx/store/fesm2015/store.js");
/* harmony import */ var _ngrx_entity__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @ngrx/entity */ "./node_modules/@ngrx/entity/fesm2015/entity.js");
/* harmony import */ var _section_actions__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./section.actions */ "./src/app/features/store/warehouse/section/section.actions.ts");



const sectionFeatureKey = 'sections';
const adapter = Object(_ngrx_entity__WEBPACK_IMPORTED_MODULE_1__["createEntityAdapter"])();
const initialState = adapter.getInitialState({
    allSectionsLoaded: false,
    currentSection: null
});
const sectionReducer = Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_0__["createReducer"])(initialState, Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_0__["on"])(_section_actions__WEBPACK_IMPORTED_MODULE_2__["addSectionSuccess"], (state, action) => adapter.upsertOne(action.data, Object.assign({}, state, { currentSection: action.data }))), Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_0__["on"])(_section_actions__WEBPACK_IMPORTED_MODULE_2__["deleteSectionSuccess"], (state, action) => adapter.removeOne(action.id, state)), Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_0__["on"])(_section_actions__WEBPACK_IMPORTED_MODULE_2__["loadSectionsSuccess"], (state, action) => adapter.addAll(action.data, state)), Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_0__["on"])(_section_actions__WEBPACK_IMPORTED_MODULE_2__["selectCurrentSectionSuccess"], (state, action) => (Object.assign({}, state, { currentSection: action.data }))));
function reducer(state, action) {
...
const featureState = Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_0__["createFeatureSelector"])(_section_reducer__WEBPACK_IMPORTED_MODULE_1__["sectionFeatureKey"]);
const selectAllSections = Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_0__["createSelector"])(featureState, _section_reducer__WEBPACK_IMPORTED_MODULE_1__["selectAll"]);
const allSectionLoaded = Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_0__["createSelector"])(featureState, state => state.allSectionsLoaded);
const selectCurrentSection = Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_0__["createSelector"])(featureState, state => state.currentSection);
...
const loadWarehouses = Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_0__["createAction"])('[Warehouse/API] Load Warehouses');
const loadWarehousesSuccess = Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_0__["createAction"])('[Warehouse/API] Load Warehouses Success', Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_0__["props"])());
const addWarehouse = Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_0__["createAction"])('[Warehouse/API] Add Warehouse', Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_0__["props"])());
const addWarehouseSuccess = Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_0__["createAction"])('[Warehouse/API] Add Warehouse Success', Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_0__["props"])());
const deleteWarehouse = Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_0__["createAction"])('[Warehouse/API] Delete Warehouse', Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_0__["props"])());
const deleteWarehouseSuccess = Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_0__["createAction"])('[Warehouse/API] Delete Warehouse Success', Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_0__["props"])());
const selectCurrentWarehouseSuccess = Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_0__["createAction"])('[Warehouse/API] Select Current Warehouse', Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_0__["props"])());
...
let WarehouseEffects = class WarehouseEffects {
    constructor(actions$, store, service) {
        this.actions$ = actions$;
        this.store = store;
        this.service = service;
        this.loadWarehouses$ = Object(_ngrx_effects__WEBPACK_IMPORTED_MODULE_2__["createEffect"])(() => this.actions$.pipe(Object(_ngrx_effects__WEBPACK_IMPORTED_MODULE_2__["ofType"])(_warehouse_actions__WEBPACK_IMPORTED_MODULE_5__["loadWarehouses"]), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_6__["withLatestFrom"])(this.store.select(_warehouse_selectors__WEBPACK_IMPORTED_MODULE_7__["allWarehouseLoaded"])), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_6__["filter"])(([_, allLoaded]) => !allLoaded), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_6__["mergeMap"])(_ => this.service.findAll().pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_6__["map"])(data => Object(_warehouse_actions__WEBPACK_IMPORTED_MODULE_5__["loadWarehousesSuccess"])({ data }))))));
        this.addWarehouse$ = Object(_ngrx_effects__WEBPACK_IMPORTED_MODULE_2__["createEffect"])(() => this.actions$.pipe(Object(_ngrx_effects__WEBPACK_IMPORTED_MODULE_2__["ofType"])(_warehouse_actions__WEBPACK_IMPORTED_MODULE_5__["addWarehouse"]), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_6__["mergeMap"])(action => this.service.save(action.data).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_6__["map"])(data => Object(_warehouse_actions__WEBPACK_IMPORTED_MODULE_5__["addWarehouseSuccess"])({ data }))))));
        this.deleteWarehouse$ = Object(_ngrx_effects__WEBPACK_IMPORTED_MODULE_2__["createEffect"])(() => this.actions$.pipe(Object(_ngrx_effects__WEBPACK_IMPORTED_MODULE_2__["ofType"])(_warehouse_actions__WEBPACK_IMPORTED_MODULE_5__["deleteWarehouse"]), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_6__["mergeMap"])(({ data }) => this.service.delete(data).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_6__["map"])(_ => Object(_warehouse_actions__WEBPACK_IMPORTED_MODULE_5__["deleteWarehouseSuccess"])({ id: data.id }))))));
    }
};
WarehouseEffects.ctorParameters = () => [
    { type: _ngrx_effects__WEBPACK_IMPORTED_MODULE_2__["Actions"] },
    { type: _ngrx_store__WEBPACK_IMPORTED_MODULE_3__["Store"] },
...
/* harmony import */ var _ngrx_store__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @ngrx/store */ "./node_modules/@ngrx/store/fesm2015/store.js");
/* harmony import */ var _ngrx_entity__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @ngrx/entity */ "./node_modules/@ngrx/entity/fesm2015/entity.js");
/* harmony import */ var _warehouse_actions__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./warehouse.actions */ "./src/app/features/store/warehouse/warehouse/warehouse.actions.ts");



const warehouseFeatureKey = 'warehouses';
const adapter = Object(_ngrx_entity__WEBPACK_IMPORTED_MODULE_1__["createEntityAdapter"])();
const initialState = adapter.getInitialState({
    allWarehousesLoaded: false,
    currentWarehouse: null
});
const warehouseReducer = Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_0__["createReducer"])(initialState, Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_0__["on"])(_warehouse_actions__WEBPACK_IMPORTED_MODULE_2__["addWarehouseSuccess"], (state, action) => adapter.upsertOne(action.data, Object.assign({}, state, { currentWarehouse: action.data }))), Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_0__["on"])(_warehouse_actions__WEBPACK_IMPORTED_MODULE_2__["deleteWarehouseSuccess"], (state, action) => adapter.removeOne(action.id, state)), Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_0__["on"])(_warehouse_actions__WEBPACK_IMPORTED_MODULE_2__["loadWarehousesSuccess"], (state, action) => adapter.addAll(action.data, state)), Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_0__["on"])(_warehouse_actions__WEBPACK_IMPORTED_MODULE_2__["selectCurrentWarehouseSuccess"], (state, action) => (Object.assign({}, state, { currentWarehouse: action.data }))));
function reducer(state, action) {
...
const featureState = Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_0__["createFeatureSelector"])(_warehouse_reducer__WEBPACK_IMPORTED_MODULE_1__["warehouseFeatureKey"]);
const selectAllWarehouses = Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_0__["createSelector"])(featureState, _warehouse_reducer__WEBPACK_IMPORTED_MODULE_1__["selectAll"]);
const allWarehouseLoaded = Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_0__["createSelector"])(featureState, state => state.allWarehousesLoaded);
const selectCurrentWarehouse = Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_0__["createSelector"])(featureState, state => state.currentWarehouse);
...
let RacksComponent = class RacksComponent {
    constructor() {
        this.form = [
            {
                row: [
